...
- `asc builds next-number` to choose the next build number for a version
    ...
    "testflight_beta": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "run": "asc builds next-number --app \"$APP_ID\" --version \"$VERSION\" --platform IOS --initial-build-number 1 --output json",
          "outputs": {
